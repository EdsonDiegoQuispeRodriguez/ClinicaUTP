<?php
require_once('../Controlador/Enfermera/listaPendientes.php');
//$id = $_GET["id"];
$sql = listaPendientes();
...
<div class="table-responsive">
        <table class="table">
                ...
                <a href="GenerarHistorial.php?idCita=<?php echo $row["idCita"];?>&id=<?php echo $id; ?>" class="table__item__link">Atender</a></td>  
                        </tr>
