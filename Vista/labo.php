...
<head>
    <title>LABORATORIO CUENTA </title>
...
<body>       
    ...
    <body>
        <div class="container">
            <div class="form__top">
                <h2><span>LOGUEO DE LA ADMINISTRADOR DE LABORATORIO</span></h2>
            </div>		
            <form class="form__reg" action="Controlador"  method="POST">
                ...
                <div class="btn__form">
                <a href="gestionlab.php"><input type="button" class="btn__submit" value="INICIAR SESION"></a>   
